...
$form=$_GET;
$id=$form['id'];
$sql = $db->prepare("SELECT id,username,email,vkey FROM register_user WHERE id = :id");
$sql->execute([':id' => $id]);
...
<div class="main">
    <form name="Donation" action="updateusers.php" method="post">
        ...
        <input type="text" name="vkey" value=" <?php print($row['vkey']); ?>">
        <br>
