...
echo implode('',$vlysine).'<='.implode('',$lysine)."<br>";
echo implode('',$vcalcium).'<='.implode('',$calcium)."<br>";
echo implode('',$vme).'<='.implode('',$me)."<br>";
echo implode('',$vprotein).'<='.implode('',$protein)."<br>";
echo 'minimise z= '. implode('',$vprice);
echo implode('',$ingredient1).'<=1000';
//$leftdata=array
//(
//
...
//foreach ($ingredient as $value) {
//    echo $value.foreach ($quantity as $value){
//        echo $value;
//    }
//}
//?>